# Monitoring Amazon WorkSpaces<a name="amazon-workspaces-monitoring"></a>
...
For more information about using CloudWatch and alarms, see the [Amazon CloudWatch User Guide](http://docs.aws.amazon.com/AmazonCloudWatch/latest/DeveloperGuide/)\.
...
1. Determine which directory the alarm applies to using the [describe\-alarms](http://docs.aws.amazon.com/cli/latest/reference/cloudwatch/describe-alarms.html) command\.
...
1. Get the list of WorkSpaces in the specified directory using the [describe\-workspaces](http://docs.aws.amazon.com/cli/latest/reference/workspaces/describe-workspaces.html) command\.
...
1. Get the CloudWatch metrics for each WorkSpace in the directory using the [get\-metric\-statistics](http://docs.aws.amazon.com/cli/latest/reference/cloudwatch/get-metric-statistics.html) command\.
