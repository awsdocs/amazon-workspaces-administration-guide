...
+ [Install the Group Policy Administrative Template for PCoIP](#gp_install_template)
  ...
  + [Enable or Disable Audio\-In Redirection for PCoIP](#gp_audio)
  + [Disable Time Zone Redirection for PCoIP](#gp_time_zone)
+ [Install the Group Policy Administrative Template Files for the WorkSpaces Streaming Protocol \(WSP\)](#gp_install_template_wsp)
  + [Configure Printer Support for WSP](#gp_local_printers_wsp)
  + [Enable or Disable Clipboard Redirection for WSP](#gp_clipboard_wsp)
  + [Enable or Disable Video\-In Redirection for WSP](#gp_video_in_wsp)
  + [Enable or Disable Audio\-In Redirection for WSP](#gp_audio_in_wsp)
  + [Disable Time Zone Redirection for WSP](#gp_time_zone_wsp)
  + [Enable or Disable Smart Card Redirection for WSP](#gp_smart_cards_in_wsp)
  + [Enable or Disable Disconnect Session on Screen Lock for WSP](#gp_lock_screen_in_wsp)
...
If needed, you can disable in\-session authentication for Windows WorkSpaces by using Group Policy settings\. You can't disable pre\-session authentication through Group Policy, but you can do so through your AD Connector directory settings by using the DisableClientAuthentication API action or the disable\-client\-authentication AWS command line interface \(AWS CLI\) command\. For more information, see AD Connector Support for Smart Cards in the *AWS Directory Service Administration Guide*\.
